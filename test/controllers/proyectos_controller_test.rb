...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference("Proyecto.count") do
      post proyectos_url, params: { proyecto: { autor: @proyecto.autor, estado: @proyecto.estado, fechadev: @proyecto.fechadev, fechapres: @proyecto.fechapres, libro: @proyecto.libro, titulo: @proyecto.titulo } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { autor: @proyecto.autor, estado: @proyecto.estado, fechadev: @proyecto.fechadev, fechapres: @proyecto.fechapres, libro: @proyecto.libro, titulo: @proyecto.titulo } }
