...
class BibliotecasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create biblioteca" do
    assert_difference("Biblioteca.count") do
      post bibliotecas_url, params: { biblioteca: { autor: @biblioteca.autor, estado: @biblioteca.estado, fechadev: @biblioteca.fechadev, fechapres: @biblioteca.fechapres, libro: @biblioteca.libro, titulo: @biblioteca.titulo } }
    end
  ...
  test "should update biblioteca" do
    patch biblioteca_url(@biblioteca), params: { biblioteca: { autor: @biblioteca.autor, estado: @biblioteca.estado, fechadev: @biblioteca.fechadev, fechapres: @biblioteca.fechapres, libro: @biblioteca.libro, titulo: @biblioteca.titulo } }
